(() => {
  ...
  const THEMES = {
    ...
    "chick-defense": {
      bpm: 132,
      scale: [261.63, 329.63, 392.0, 523.25, 587.33, 659.25],
      style: "adventure",
    },
    "jet-strike": {
      bpm: 148,
      scale: [220.0, 277.18, 329.63, 392.0, 493.88, 587.33],
      style: "arcade",
    },
    "lava-monster": {
      bpm: 142,
      scale: [196.0, 246.94, 293.66, 349.23, 440.0, 523.25],
      style: "chase",
    },
    "zombie-run": {
      bpm: 150,
      scale: [174.61, 220.0, 261.63, 329.63, 392.0, 523.25],
      style: "rush",
    },
    "number-hole": {
      bpm: 136,
      scale: [246.94, 311.13, 369.99, 493.88, 554.37, 659.25],
      style: "arcade",
    },
    "penalty-kick": {
      bpm: 132,
      scale: [196.0, 246.94, 293.66, 392.0, 440.0, 587.33],
      style: "chase",
    },
    "dino-hunt": {
      bpm: 140,
    ...
    "wisdom-quiz": {
      bpm: 108,
      scale: [261.63, 329.63, 392.0, 440.0, 523.25, 587.33],
      style: "puzzle",
    },
    "fortune-draw": {
      bpm: 96,
